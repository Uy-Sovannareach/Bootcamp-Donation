...
import { getTotalRaised, getDonorCount, getRecentDonations, getDonorsByAmount } from '../../../action/paymentkanthabopha';
      ...
      <main className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
            Support Kantha Bopha Hospital with a Donation
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              <Image
                src="/kanhabopha.webp"
                alt="Kantha Bopha Hospital"
                width={800}
                height={600}
                className="w-full h-auto rounded-xl shadow-lg mb-8"
              />
              <p className="text-base text-gray-700 leading-relaxed">
                Kantha Bopha Hospital is a beacon of hope for children in Cambodia, providing essential medical care and support to those in need. Unfortunately, the hospital faces numerous challenges, including limited resources and increasing demand for services. By supporting Kantha Bopha Hospital, you are helping to ensure that vulnerable children receive the care they deserve. Your donation will go directly toward medical supplies, equipment, and the dedicated staff who work tirelessly to save lives. Join us in making a difference — every contribution counts.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <a href='/payment/supportKanthaBopha' className="w-full bg-white border border-emerald-500 text-emerald-500 hover:bg-emerald-100 font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-200 text-center block">
                  Donated now
                </a>
              </div>
