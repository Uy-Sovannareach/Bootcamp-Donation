...
import { getTotalRaised, getDonorCount, getRecentDonations, getDonorsByAmount } from '../../../action/paymentpreahvihear';
      ...
      <main className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
            Support the Restoration of Preah Vihear Temple
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Main Image and Description Section */}
            <div className="md:col-span-2">
              <Image
                src="/Crumbling-Preah-Vihear-structure.webp"
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                Preah Vihear Temple, a UNESCO World Heritage site, stands as a symbol of Cambodia’s rich history and cultural pride. Unfortunately, time, weather, and conflict have caused significant damage to this ancient landmark. By supporting the restoration efforts, you help preserve a national treasure for future generations. Your donation will go directly toward structural repairs, preservation of sacred carvings, and maintaining the temple’s spiritual and historical significance. Join us in protecting this priceless heritage — every contribution makes a lasting difference.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <a href='/payment/preahVihearTemple' className="w-full bg-white border border-emerald-500 text-emerald-500 hover:bg-emerald-100 font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-200 text-center block">
                  Donated now
                </a>
              </div>
