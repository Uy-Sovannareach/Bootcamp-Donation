...
import { getTotalRaised, getDonorCount, getRecentDonations, getDonorsByAmount } from '../../../action/paymenteric';
...
<main className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
            Together for Eric: A Campaign to Support His Recovery
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                Together for Eric – Eric is a kind and strong person who is now facing one of the toughest battles of his life: cancer. He needs urgent medical treatment, and the hospital costs are overwhelming for him and his family. With your support, we can help lift this heavy burden and give Eric the chance to focus on healing and recovery. Every donation, big or small, will make a difference and bring hope to Eric during this difficult time. Let’s stand together and show Eric he is not alone in this fight.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <a href='/payment/togetherForEric' className="w-full bg-white border border-emerald-500 text-emerald-500 hover:bg-emerald-100 font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-200 text-center block">
                  Donated now
                </a>
              </div>
