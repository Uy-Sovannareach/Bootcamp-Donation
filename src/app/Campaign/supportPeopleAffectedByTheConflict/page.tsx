...
import { getTotalRaised, getDonorCount, getRecentDonations, getDonorsByAmount } from '../../../action/paymentconflict';
      ...
      <main className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
            Support people affected by the conflict between Thailand and Cambodia
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              <Image
                src="/warpeople.webp"
                alt="Support people affected by the conflict between Thailand and Cambodia"
                width={800}
                height={600}
                className="w-full h-auto rounded-xl shadow-lg mb-8"
              />
              <p className="text-base text-gray-700 leading-relaxed">
                “The ongoing conflict between Thailand and Cambodia has left many families displaced, vulnerable, and in urgent need of support. Innocent people are facing loss of shelter, food, and security, with children and the elderly being the most affected. By standing together to provide humanitarian aid—whether through food, medical care, or safe shelter—we can bring comfort and hope to those suffering in this difficult time. Every act of support helps rebuild lives and restore dignity to those impacted by this conflict. Let’s unite in compassion and make a meaningful difference.”
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <a href='/payment/supportPeopleAffectedByTheConflict' className="w-full bg-white border border-emerald-500 text-emerald-500 hover:bg-emerald-100 font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-200 text-center block">
                  Donated now
                </a>
              </div>
