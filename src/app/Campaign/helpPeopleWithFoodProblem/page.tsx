...
import { getTotalRaised, getDonorCount, getRecentDonations, getDonorsByAmount } from '../../../action/paymentfoodproblem';
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              <Image
                src="/givenfood.jpg"
                alt="Help People With Food Problem"
                width={800}
                height={600}
                className="w-full h-auto rounded-xl shadow-lg mb-8"
              />
              <p className="text-base text-gray-700 leading-relaxed">
                Many families in Cambodia are struggling with hunger, with parents skipping meals and children going to school on empty stomachs. By coming together to provide food and support, we can bring hope, health, and dignity to those in need. Even the smallest act of kindness can help fill an empty plate and change a life.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full bg-white border border-emerald-500 text-emerald-500 hover:bg-emerald-100 font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-200">
                  Donated now
                </button>
              </div>
